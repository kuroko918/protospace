...
describe Image do
  describe 'associations' do
    it 'is associated with prototypes' do
      ...
      image = create(:image, :main_image, prototype: prototype)
  ...
  describe '#create' do
    it 'has the wrong content format' do
      image = build(:image, :main_image, image: fixture_file_upload("img/sample.mp4", 'image/mp4'))
      image.valid?
    ...
    context 'without content attribute' do
      it 'returns error' do
        image = build(:image, :main_image, image: nil)
        image.valid?
    ...
    context 'without status attribute' do
      it 'returns error' do
        image = build(:image, :main_image, status: nil)
        image.valid?
